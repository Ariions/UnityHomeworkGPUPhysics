...
public class EntitySystem : MonoBehaviour
{
    ...
    void Update()
    {
        inputVector = new Vector3(-Input.GetAxis("Vertical") * inputMod, 0, Input.GetAxis("Horizontal") * inputMod);
        ...
        computeShader.SetVector("_ExternalForce", new Vector3(wind.x, -gravity, wind.y));
        computeShader.SetVector("_inputAxis", inputVector);
    ...
    void UpdateBuffers()
    {
        ...
        Entity[] entities = new Entity[instanceCount];
